...
const FASE_COLORS: Record<string, { dot: string; top: string }> = {
  ...
  "Firma de honorarios":    { dot: "bg-sky-400",      top: "border-t-sky-400" },
  ...
  "Honorarios pagados":     { dot: "bg-emerald-500", top: "border-t-emerald-500" },
};
      ...
      <div className="flex gap-3 overflow-x-auto pb-4">
        {fases.map((fase) => {
          ...
          return (
            <div
              key={fase}
              className={`flex-shrink-0 w-56 flex flex-col border-t-[3px] ${colors.top} bg-[#f3f2f7]`}
            >
              {/* Header */}
