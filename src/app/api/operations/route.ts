    ...
    if (existingSupplier) {
      ...
      const [newSupplier] = await db
        ...
        .values({
          ...
          cif: proveedor_cif || null,
          cnae: proveedor_cnae || null,
          direccion: proveedor_direccion || null,
          provincia: proveedor_provincia || null,
          nombre_comercial: proveedor_nombre_comercial || null,
