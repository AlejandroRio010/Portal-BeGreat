...
import { db } from "@/db";
import { clients, contacts, operations, suppliers, clientNotes, customFields, customFieldValues, clientDocuments, operationDocuments, avalDocuments, docChecklistTemplates, docChecklistCustomItems, docChecklistEntries, entityTasks } from "@/db/schema";
      ...
      <div className="mx-8 mb-6 grid grid-cols-3 gap-4 items-start">
        ...
        <div className="col-span-2 flex flex-col gap-6 min-w-0">
          ...
          <EntityTasksSection
            ...
            assignees={[{ id: userId, nombre: supplierInfo?.nombre ?? "Proveedor" }]}
          />
