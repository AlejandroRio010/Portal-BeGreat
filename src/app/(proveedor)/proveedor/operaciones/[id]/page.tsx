                ...
                <div key={avIdx} className="pt-3 mt-3 border-t border-gray-100">
                  ...
                  {av.tipo === "persona_fisica" ? (
                    <dd className="text-sm text-gray-800">
                      {av.contact_id ? (
                        <Link href={`/proveedor/clientes/${avalContactClientId(av.contact_id)}/contactos/${av.contact_id}`} className="font-medium text-[#2E1A47] hover:underline">{av.nombre}</Link>
                      ) : (
                    ...
                    <dd className="text-sm text-gray-800">
                      {av.client_id ? (
                        <Link href={`/proveedor/clientes/${av.client_id}`} className="font-medium text-[#2E1A47] hover:underline">{av.nombre}</Link>
                      ) : (
                        <p className="font-medium">{av.nombre}</p>
                      )}
