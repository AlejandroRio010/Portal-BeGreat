                ...
                <div className="col-span-1 space-y-4 border border-gray-200 p-4 bg-gray-50/50">
                  ...
                  {isFactura && (
                    <div className="space-y-3">
                      ...
                      {/* Los vínculos con facturas de Holded se quitaron del formulario
                          (2026-07-30, decisión de Alejandro): el cobro/pago se controla
                          directamente en Holded. Los vínculos existentes se conservan. */}
                    </div>
                  )}
