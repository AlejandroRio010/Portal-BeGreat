...
export default function NotasContactoForm({ contactoId, initialNotas }: { contactoId: string; initialNotas: string | null }) {
  ...
  async function handleSave() {
    setSaving(true);
    setSaved(false);
    const res = await fetch(`/api/admin/entidades/oficinas/contactos/${contactoId}/notas`, {
      method: "PATCH",
  ...
  return (
    <div className="bg-white border border-gray-200">
      <div className="bg-[#EEEBF3] px-5 py-3 border-b border-gray-200 flex items-center justify-between">
        <h3 className="text-xs font-bold text-[#2E1A47] uppercase tracking-wider">Notas sobre esta persona</h3>
      ...
      <div className="px-5 py-4">
        <textarea
          ...
          rows={5}
          placeholder="Relación con BeGreat, condiciones, historial de conversaciones, carácter del trato..."
