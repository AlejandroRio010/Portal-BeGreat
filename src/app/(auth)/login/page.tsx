  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center px-6 py-10 overflow-hidden bg-[#2E1A47]">
      ...
      <div className="relative z-10 w-full max-w-md" style={{ zoom: 0.92 }}>
        ...
        {/* Credenciales — tarjeta de cristal redondeada */}
        <form onSubmit={handleSubmit}
          ...
          {error && (
            <p className="text-sm text-red-100 bg-red-500/20 border border-red-400/40 rounded-xl px-3.5 py-2.5">{error}</p>
          )}

          <button
            type="submit"
            disabled={loading || clearing}
            className="w-full bg-gradient-to-b from-[#FFE14D] to-[#FFC800] text-[#2E1A47] py-3 rounded-xl text-sm font-bold tracking-wide hover:from-[#FFE97A] hover:to-[#FFD21A] shadow-[0_10px_28px_-8px_rgb(255_210_0/0.55)] transition-colors disabled:opacity-60 flex items-center justify-center gap-2"
          >
